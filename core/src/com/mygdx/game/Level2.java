...
public class Level2 extends Level
{
   public Level2(MyGdxGame game)
   {
       ...
       silver_path=new Texture ("silver path_horizontal.png");
       fiveteen=new TextureRegion(silver_path);  
       ...
       ten=new TextureRegion(non);
       horizontal_block =new Texture("HorizontalBlock.png"); 
       eleven=new TextureRegion(horizontal_block);
       ...
       five=new TextureRegion(empty);
       seven=new TextureRegion(empty);
